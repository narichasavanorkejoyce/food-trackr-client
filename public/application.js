...
/***/ (function(module, exports, __webpack_require__) {
	...
	var trackrEvents = __webpack_require__(12);
	var uxLogic = __webpack_require__(36);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(data).done(ui.successSignUp).fail(ui.failureSignUp);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addNewItem = function addNewItem(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.addNewItem(data).done(ui.addNewItemSuccess).fail(ui.addNewItemFail);
	  // console.log('addNewItem ran!')
	};

	var getFoodItems = function getFoodItems(event) {
	  event.preventDefault();
	  api.getFoodItems().done(ui.getFoodItemsSuccess).fail(ui.getFoodItemsFail);
	};

	var getFoodItemsAgain = function getFoodItemsAgain() {
	  // event.preventDefault()
	  api.getFoodItems().done(ui.getFoodItemsSuccess).fail(ui.getFoodItemsFail);
	};

	var getGroceryList = function getGroceryList(event) {
	  event.preventDefault();
	  api.getGroceryList().done(ui.getGroceryListSuccess).fail(ui.getGroceryListFail);
	};

	var getGroceryListAgain = function getGroceryListAgain() {
	  // event.preventDefault()
	  api.getGroceryList().done(ui.getGroceryListSuccess).fail(ui.getGroceryListFail);
	};
	...
	var deleteItem = function deleteItem() {
	  ...
	  api.deleteItem(id).done(ui.deleteItemSuccess, getFoodItemsAgain).fail(ui.deleteItemFail);
	};

	var deletePurchasedItem = function deletePurchasedItem() {
	  // console.log('deletePurchasedItem ran!')
	  event.preventDefault();
	  var id = $(this).attr('data-id');
	  // console.log('id is:' + id)
	  api.deletePurchasedItem(id).done(ui.deletePurchasedItemSuccess, getGroceryListAgain).fail(ui.deletePurchasedItemFail);
	};
	...
	var updateQuantity = function updateQuantity(event) {
	  ...
	  var id = $(this).attr('data-id');
	  // console.log('id is:' + id)
	  api.updateQuantity(id).done(ui.updateQuantitySuccess, getGroceryListAgain).fail(ui.updateQuantityFail);
	  // console.log('updateQuantity ran!')
	};

	var trackrHandlers = function trackrHandlers() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addNewItem = function addNewItem(data) {
	  // console.log(data)
	  return $.ajax({
	...
	var getFoodItems = function getFoodItems(data) {
	  // console.log(data)
	  return $.ajax({
	...
	var getGroceryList = function getGroceryList(data) {
	  // console.log(data)
	  return $.ajax({
	...
	var deletePurchasedItem = function deletePurchasedItem(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/items/' + id,
	    method: 'DELETE',
	    headers: {
	...
	var updateQuantity = function updateQuantity(id) {
	  // data = store.item
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(9);
	var displayFoodItemsTemplate = __webpack_require__(15);
	var displayGroceryListTemplate = __webpack_require__(35);

	var addNewItemSuccess = function addNewItemSuccess(data) {
	  // console.log('addNewItemSuccess worked!')
	  store.item = data.item;
	  $('#add-item-response').text('Success! Add another item or click FOOD to see all items.');
	};

	var addNewItemFail = function addNewItemFail() {
	  // console.error(error)
	  // console.log('addNewItem failed!')
	  $('#add-item-response').text('All field forms are required. Please try again.');
	};

	var getFoodItemsSuccess = function getFoodItemsSuccess(data) {
	  // console.log(data)
	  // console.log('getAllItems worked!')
	  $('#show-food-list').empty();
	  $('#show-grocery-list').empty();
	  var displayFoodItems = displayFoodItemsTemplate({ items: data.items });
	...
	var getFoodItemsFail = function getFoodItemsFail() {
	  // console.error(error)
	  // console.log('getAllItems failed.')
	};

	var getGroceryListSuccess = function getGroceryListSuccess(data) {
	  // console.log(data)
	  // console.log('getAllItems worked!')
	  $('#show-food-list').empty();
	  $('#show-grocery-list').empty();
	  var displayGroceryList = displayGroceryListTemplate({ items: data.items });
	...
	var getGroceryListFail = function getGroceryListFail() {
	  // console.error(error)
	  // console.log('getAllItems failed.')
	};

	var updateQuantitySuccess = function updateQuantitySuccess(data) {
	  // console.log(data)
	  // console.log('updateQuantity worked!')
	  $('#show-food-list').empty();
	};

	var updateQuantityFail = function updateQuantityFail() {
	  // console.error(error)
	...
	var deleteItemFail = function deleteItemFail() {
	  // console.error(error)
	};

	var deletePurchasedItemSuccess = function deletePurchasedItemSuccess(data) {
	  // console.log(data)
	  // console.log('item has been deleted!')
	  $('#show-grocery-list').empty();
	};

	var deletePurchasedItemFail = function deletePurchasedItemFail() {
	  // console.error(error)
	};

	module.exports = {
	  addNewItemSuccess: addNewItemSuccess,
	  addNewItemFail: addNewItemFail,
	  getFoodItemsSuccess: getFoodItemsSuccess,
	  getFoodItemsFail: getFoodItemsFail,
	  getGroceryListSuccess: getGroceryListSuccess,
	  getGroceryListFail: getGroceryListFail,
	  updateQuantitySuccess: updateQuantitySuccess,
	  updateQuantityFail: updateQuantityFail,
	  deleteItemSuccess: deleteItemSuccess,
	  deleteItemFail: deleteItemFail,
	  deletePurchasedItemSuccess: deletePurchasedItemSuccess,
	  deletePurchasedItemFail: deletePurchasedItemFail
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "      <tr data-id=\""
	    ...
	    + "\">\n        <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.food_name : stack1), depth0))
	    + "</td>\n        <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.days_to_exp : stack1), depth0))
	    + "</td>\n        <td><button type=\"button\" class=\"remove-item btn btn-default\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span class=\"glyphicon glyphicon-remove\" aria-hidden=\"true\"></span></button></td>\n        <td><button type=\"button\" class=\"move-to-grocery-list btn btn-default\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span class=\"glyphicon glyphicon-shopping-cart\" aria-hidden=\"true\"></span></button></td>\n      </tr>\n  </tbody>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<table class=\"table table-sm\" id=\"food-list-table\">\n  <thead>\n    <tr>\n      <th>Name</th>\n      <th>Days Left</th>\n      <th>Delete</th>\n      <th>Buy Again</th>\n    </tr>\n  </thead>\n\n\n  <tbody>\n"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "      <tr data-id=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.food_name : stack1), depth0))
	    + "</td>\n        <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.store_name : stack1), depth0))
	    + "</td>\n        <td><button type=\"button\" class='btn btn-default purchase-item' data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span class=\"glyphicon glyphicon-ok\" aria-hidden=\"true\"></span></button></td>\n      </tr>\n    </tbody>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<table class=\"table table-sm\" id=\"grocery-list-table\">\n    <thead>\n      <tr>\n        <th>Food Name</th>\n        <th>Store Name</th>\n        <th>Purchased</th>\n      </tr>\n    </thead>\n\n    <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.items : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n</table>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var uxLogicHandlers = function uxLogicHandlers() {
	...
	module.exports = {
	  uxLogicHandlers: uxLogicHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
